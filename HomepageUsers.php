...
if ($_SERVER["REQUEST_METHOD"] == "POST")
    ...
    $_SESSION["favanimal"] = $animalchoice;
    }
?>
...
<?php
    echo "Hi " . $_SESSION["usersName"] . ". Your Favorite animal is a " . $_SESSION["favanimal"] . ". You should search that animal to find out how many we have left!";
?>
